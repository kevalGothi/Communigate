...
if(isset($_POST['submit'])){
    ...
    if($pass != $cpass){
        $error[] = 'password not matched!';
          ...
          $insert = "update `members` set img_source='$folder', hno='$hno', email='$email', name='$name', mno='$mno', total='$total' , password='$pass' where hno=$hno";
    ...
    <?php
      ...
      ?>
         <img src="<?php if ($row['img_source'] == '../images/') { echo '../images/defualt.png'; } else { echo $row['img_source']; } ?>" style="width:50%; height:50%; border-radius:50%;">   <br>       
          ...
          <a href="/user/member.php" id="cancelButton"  class="form-btn" style="width:100%;">Cancel</a>
